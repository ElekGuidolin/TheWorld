...
namespace TheWorld.Models
{
    public class WorldContextSeedData
    {
        ...
        {
            if (await _userManager.FindByEmailAsync("elek@theworld.com") == null)
            {
                //Add the User
                var newUser = new WorldUser()
                {
                    UserName = "ElekGuidolin",
                    Email = "elek@theworld.com"
                };

                await _userManager.CreateAsync(newUser, "&Laine0305");
            }
            ...
            if (!_context.Trips.Any())
            {
                var usTrip = new Trip()
                {
                    ...
                    Stops = new List<Stop>()
                    {
                        new Stop {Name = "Atlanta, GA", Arrival = new DateTime(2016, 3, 3), Latitude = 33.748995, Longitude = -84.387982, Order = 0 },
                        new Stop {Name = "New York, NY", Arrival = new DateTime(2016, 3, 4), Latitude = 40.712784, Longitude = -84.387982, Order = 1 },
                        new Stop {Name = "Boston, MA", Arrival = new DateTime(2016, 3, 11), Latitude = 42.360082, Longitude = -84.387982, Order = 2 },
                        new Stop {Name = "Chicago, IL", Arrival = new DateTime(2016, 3, 17), Latitude = 41.878114, Longitude = -84.387982, Order = 3 },
                        new Stop {Name = "Seattle, WA", Arrival = new DateTime(2016, 3, 25), Latitude = 47.606209, Longitude = -84.387982, Order = 4 },
                        new Stop {Name = "Atlanta, GA", Arrival = new DateTime(2016, 4, 5), Latitude = 33.748995, Longitude = -84.387982, Order = 5 },
                    }
                };
